...
public class PruebaPsicometricaDAO implements Persistible<PruebaPsicometrica> {
    ...
    private Long insertar(PruebaPsicometrica prueba) throws BaseDatosException {
        ...
        try (Connection conn = dbConfig.obtenerConexion();
            ...
            // Uso de Timestamp para compatibilidad con TIMESTAMPTZ de Postgres
            ...
            try (ResultSet rs = stmt.getGeneratedKeys()) {
                ...
                else throw new BaseDatosException("ID no generado en Postgres.");
            }
        } catch (SQLException e) {
            throw new BaseDatosException("Error de inserción en Render: " + e.getMessage(), e);
        }
    }
