...
public class ConductorDAO implements Persistible<Conductor> {
    ...
    private Long insertar(Conductor conductor) throws BaseDatosException {
        ...
        // Postgres maneja RETURN_GENERATED_KEYS correctamente con BIGSERIAL
        try (Connection conn = dbConfig.obtenerConexion();
            ...
            try (ResultSet rs = stmt.getGeneratedKeys()) {
                ...
                throw new BaseDatosException("Error: No se generó ID para el conductor.");
            }
        } catch (SQLException e) {
            throw new BaseDatosException("Error en Postgres Cloud: " + e.getMessage(), e);
        }
    }
